      ...
      <section class="gallery">
        <figure>
          ...
          <figcaption>
            ...
            <ul>
              <li>
                Developed an internal website for over 10,000 employees to track
                their completion of internal training courses, collaborating
                with a team of 4 members.
              </li>
              <li>
                Designed and implemented multiple web pages that interacted with
                and retrieved data through a REST API, utilizing React.js, Java,
                and MySQL
              </li>
              <li>
                DStreamlined manual completion tracking processes, leading to a
                monthly labor hour reduction of 100 hours
              </li>
        ...
        <figure>
          <img src={bpo} alt="bpo" />
          <figcaption>
            <h3>Optimization and automation of operation</h3>
            <ul>
              <li>
              ...
              <li>
                Designed and implemented a new website for BPO operations using
                Power Platform
              </li>
              <li>
        ...
        <figure>
          ...
          <figcaption>
            ...
            <ul>
              ...
              <li>
                Led multiple small teams in the development of virtual robots as
                a proficient team leader
              </li>
              <li>
                Managed and oversaw the deployment of virtual robots through
                UiPath Orchestrator, ensuring seamless execution and performance
                monitoring
              </li>
        ...
        <figure>
          ...
          <figcaption>
            ...
            <ul>
              <li>
                Developed a website for market place using Vue.js, collaborating
